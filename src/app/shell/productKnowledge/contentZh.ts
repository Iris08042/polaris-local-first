...
\`\`\``,
      ...
      },
      {
        heading: '记忆、上下文和资料回放',
        body: [
          '无尽夏当前只有一套生效的记忆链：角色设定、当前聊天的滚动摘要、最近 200 条真实消息，以及 Ombre Brain（OB）按需召回的长期记忆。北极星旧个人记忆、跨对话摘要和向量召回不进入请求，也不能被工具读写。',
          '滚动摘要只负责当前这段聊天的连续性。最近 200 条真实用户/助手消息保留原文；更早内容每累积 50 条自动融合一次，也可以在记忆页手动同步。摘要与较新的原文冲突时，以原文为准。',
